...
class JpaStudentRepositoryTest {
    ...
    void whenFindingAllStudentsShouldReturnSliceOfAllStudents() {
        ...
        assertThat(studentStream).containsExactly(new Student(1L, UUID.fromString("1ec9652d-a39b-42a3-af5f-9a622ad23574"),
                                                              new Group(),
                                                              "Jane",
                                                              "Doe",
                                                              Collections.emptySortedSet()),
                                                  new Student(2L, UUID.fromString("ed686bcd-0b41-4888-b802-b259c6f66198"),
                                                              new Group(),
                                                              "Student",
                                                              "ToRemove",
                                                              Collections.emptySortedSet()),
                                                  new Student(3L, UUID.fromString("38ac6a24-d493-4876-a5f9-170590639c4a"),
                                                              new Group(),
                                                              "Student2",
                                                              "McStudent2",
                                                              Collections.emptySortedSet()));
