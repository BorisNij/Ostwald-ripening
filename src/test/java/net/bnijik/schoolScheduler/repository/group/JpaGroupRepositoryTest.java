...
class JpaGroupRepositoryTest {
    ...
    void whenFindingAllGroupsPageShouldReturnSliceOfAllGroups() {
        ...
        assertThat(groupStream).containsExactly(new Group(Collections.emptyList(), 1L, UUID.fromString("6080581c-55d7-42eb-bd75-04210de0d6b3"), "BB-22"),
                                                new Group(Collections.emptyList(), 2L, UUID.fromString("28e8f392-7c1c-4f9e-9c5b-a885db9132db"), "CC-33"));
    }
    ...
    void whenFindingGroupsByMaxStudentCountShouldReturnCorrectGroups() {
        Group group1 = new Group(Collections.emptyList(), 1, UUID.fromString("6080581c-55d7-42eb-bd75-04210de0d6b3"),"BB-22");
        Group group2 = new Group(Collections.emptyList(), 2, UUID.fromString("28e8f392-7c1c-4f9e-9c5b-a885db9132db"),"CC-33");
        Group group3 = new Group(Collections.emptyList(), 3, UUID.fromString("ff15e2a1-d6f1-4f89-b9e3-a4ec6a4cadfc"),"Group to Delete");
    ...
    void whenDeletingGroupShouldRemoveFromDatabase() {
        Group groupToDelete = new Group(Collections.emptyList(), 3, UUID.fromString("ff15e2a1-d6f1-4f89-b9e3-a4ec6a4cadfc"),"Group to Delete");
    ...
    void whenUpdatingExistingGroupShouldUpdateGroup() {
        ...
        assertThat(updated.groupName()).isEqualTo(modifiedGroup.groupName());
    }
