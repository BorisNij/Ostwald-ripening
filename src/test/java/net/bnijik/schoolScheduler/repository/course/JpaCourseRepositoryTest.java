...
class JpaCourseRepositoryTest {
    ...
    void whenFindingCourseByIdShouldReturnTheRightCourse() {
        final Course expected = new Course(2L, UUID.fromString("30344369-6277-4923-9274-68358441f461"), "Course2", "Description2", Collections.emptySet(), new Professor(), Collections.emptySet());
    ...
    void whenFindingAllCoursesPageShouldReturnSliceOfAllCoursesOnPage() {
        ...
        assertThat(courses).containsExactly(new Course(1L, UUID.fromString("5d95d982-0576-4db4-92ab-bdff2e6db9f0"),"Course1", "Description1", Collections.emptySet(), new Professor(), Collections.emptySet()),
                                            new Course(2L, UUID.fromString("30344369-6277-4923-9274-68358441f461"),"Course2", "Description2", Collections.emptySet(), new Professor(), Collections.emptySet()));
    ...
    void whenUpdatingExistingCourseShouldUpdateCourse() {
        ...
        final Course entity = new Course(3L, UUID.fromString("031c1fc5-3dd9-49f6-b46f-fce9db1684ac"),"Modified course name", "Modified description", Collections.emptySet(),
                                         mainInstructor, Collections.emptySet());
    ...
    void whenFindingCoursesForAStudentShouldReturnTheCorrectCourses() {
        ...
        assertThat(enrolledCourses).containsExactly(new Course(1L, UUID.fromString("5d95d982-0576-4db4-92ab-bdff2e6db9f0"),"Course1", "Description1", Collections.emptySet(), new Professor(), Collections.emptySet()),
                                                    new Course(2L, UUID.fromString("30344369-6277-4923-9274-68358441f461"),"Course2", "Description2", Collections.emptySet(), new Professor(), Collections.emptySet()));
    }
